...
from .schema import all_Products_Query, get_all_vendors_schema,get_all_categories_schema,get_all_products_schema,get_vendor_by_id_schema,get_product_by_id_schema,get_products_by_category_slug_schema,get_all_subCategories_schema
...
def getSubCategories(request):
    print(get_all_subCategories_schema)
